...
sudo scutil --set ComputerName "macnuno"
sudo scutil --set HostName "macnuno"
sudo scutil --set LocalHostName "macnuno"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "macnuno"
